...
| 5 | Multiple titles | "Inception and Interstellar" (or 10 titles) | LLM identifies all named titles; up to 2 most relevant are combined for HyDE; **all** named titles excluded from results, however many there were |
